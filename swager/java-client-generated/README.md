...
- API version: 0.0.1
  - Build date: 2023-10-20T03:35:45.261925291Z[GMT]
...
*CloudsApi* | [**deleteCloudById**](docs/CloudsApi.md#deleteCloudById) | **DELETE** /clouds/{cloud_id} | Метод удаления заказа из облака по ID
